...
namespace Datamigratie.Data.Migrations
{
    ...
    [Migration("20260307162517_PropertyMapping")]
    partial class PropertyMapping
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Datamigratie.Data.Entities.PropertyMapping", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
                    ...
                    b.HasIndex("MappingId", "Property");

                    b.HasIndex("MappingId", "Property", "SourceId")
                        .IsUnique();
            ...
            modelBuilder.Entity("Datamigratie.Data.Entities.PropertyMapping", b =>
                {
                    b.HasOne("Datamigratie.Data.Entities.ZaaktypenMapping", "Mapping")
                        .WithMany()
