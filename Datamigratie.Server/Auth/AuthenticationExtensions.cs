    ...
    public static class AuthenticationExtensions
    {
        ...
        public static void AddAuth(this IServiceCollection services, Action<AuthOptions> setOptions)
        {
            ...
            services.AddScoped(s =>
            {
                ...
                return new DmtUser { IsLoggedIn = isLoggedIn, Name = name, Email = email, Roles = roles, HasFunctioneelBeheerderAccess = hasFunctioneelBeheerderAccess };
            });
        ...
        public static IEndpointRouteBuilder MapDmtAuthEndpoints(this IEndpointRouteBuilder endpoints)
        {
            endpoints.MapGet("api/logoff", LogoffAsync).AllowAnonymous().ExcludeFromDescription();
            endpoints.MapGet("api/me", (DmtUser user) => user).AllowAnonymous().ExcludeFromDescription();
