    ...
    IOptions<OpenZaakApiOptions> openZaakOptions) : IStartMigrationService
{
    ...
    private async Task ExecuteMigration(Data.Entities.Migration migration, List<DetZaakMinimal> zaken, Guid zaaktypenMappingId, Guid openZaaktypeId, RsinMapping rsinMapping, Dictionary<string, Guid> statusMappings, Dictionary<string, Guid> resultaatMappings, Dictionary<string, string> documentstatusMappings, Dictionary<string, Dictionary<string, string>> documentPropertyMappings, Dictionary<bool, ZaakVertrouwelijkheidaanduiding> vertrouwelijkheidMappings, Dictionary<string, Guid> besluittypeMappings, CancellationToken ct)
    {
    ...
    private async Task MigrateSingleZaakAsync(Migration migration, DetZaakMinimal zaakMinimal, Guid openZaaktypeId, RsinMapping rsinMapping, Dictionary<string, Guid> resultaatMappings, Dictionary<string, Guid> statusMappings, Dictionary<string, string> documentstatusMappings, Dictionary<string, Dictionary<string, string>> documentPropertyMappings, Dictionary<bool, ZaakVertrouwelijkheidaanduiding> zaakVertrouwelijkheidMappings, Dictionary<string, Guid> besluittypeMappings, CancellationToken ct)
    {
