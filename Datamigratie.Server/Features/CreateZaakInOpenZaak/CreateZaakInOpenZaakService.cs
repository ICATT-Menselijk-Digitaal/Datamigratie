...
namespace Datamigratie.Server.Features.CreateZaakInOpenZaak
{
    ...
    public class CreateZaakResult
    {
        ...
        public OzZaak? CreatedZaak { get; private set; }

        private CreateZaakResult(bool isSuccess, string? errorMessage = null, OzZaak? createdZaak = null)
        {
            IsSuccess = isSuccess;
            ErrorMessage = errorMessage;
            CreatedZaak = createdZaak;
        }

        public static CreateZaakResult Success(OzZaak createdZaak) => new(true, createdZaak: createdZaak);
