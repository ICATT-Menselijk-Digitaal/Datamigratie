...
namespace Datamigratie.Server.Features.Mapping.GlobalMapping.GetOverview;

[ApiController]
[Route("api/[controller]")]
//[Authorize]
public class GetGlobalMappingOverviewController(DatamigratieDbContext dbContext, ILogger<GetGlobalMappingOverviewController> logger) : ControllerBase
{
    [HttpGet]
