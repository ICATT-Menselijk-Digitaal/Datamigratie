...
| ---------------------- | --------------------------------- | --------- | ------------------------------------------------------------------------------------------------------------------------------------------------------ |
| `ZaakConcurrencyLimit` | `Migration__ZaakConcurrencyLimit` | `1`       | Aantal zaken dat gelijktijdig gemigreerd wordt. Een hogere waarde kan de migratiesnelheid verhogen, maar vergroot ook de belasting op de OpenZaak API. Aangezien de maximale waarde sterk afhankelijk is van de omgeving waarop de migratie wordt uitgevoerd adviseren wij om op een representatieve testomgeving verschillende waardes uit te proberen. Ter indicatie, de ontwikkelomgeving kon een limiet van 30 aan. Nb. boven een bepaalde waarde zal de migratie snelheid waarschijnlijk niet meer toenemen. Het absolute maximum vinden, van wat teschnisch haalbaar is, heeft derhalve weinig toegevoegde waarde. Wanneer de waarde te hoog ingesteld wordt zullen er CircuitBreaker meldingen in de resultaten verschijnen. De migratie wordt dan automatisch stop gezet. |
