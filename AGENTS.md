...
**Best practices**
Before writing or modifying any frontend code, read [frontend-best-practices.md](./frontend-best-practices.md). Key principles: use semantic HTML over divs, prefer browser defaults over custom CSS/JS, and use the project's CSS custom properties — never hardcode spacing, color, or typography values.
